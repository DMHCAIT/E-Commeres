  ...
  const hrFeatures = [
    {
      ...
      features: ["Employee Profiles", "Document Management", "Performance Reviews"],
    },
    {
      icon: Calendar,
      title: "Time & Attendance",
      description: "Advanced time tracking with automated attendance management",
      color: "from-green-400 to-green-600",
      features: ["Time Clock", "Leave Management", "Shift Scheduling"],
    },
    {
      icon: DollarSign,
      ...
      features: ["Salary Processing", "Tax Management", "Bonus Calculations"],
    },
    {
      icon: BarChart3,
      title: "HR Analytics",
      ...
      features: ["Performance Metrics", "Turnover Analysis", "Custom Reports"],
    },
    {
      icon: Award,
      title: "Performance Management",
      description: "Goal setting, reviews, and employee development tracking",
    ...
    },
    {
      ...
      features: ["Training Modules", "Skill Assessment", "Certification Tracking"],
    }
  ];

  const benefits = [
    { icon: Zap, title: "50% Faster Onboarding", description: "Streamlined processes reduce time-to-productivity" },
    { icon: Shield, title: "99.9% Data Security", description: "Enterprise-grade security for sensitive HR data" },
    { icon: CloudLightning, title: "Real-time Analytics", description: "Instant insights into workforce metrics" },
    { icon: Globe, title: "Global Compliance", description: "Compliant with international labor laws" },
    { icon: Smartphone, title: "Mobile-First Design", description: "Access HR tools from anywhere, anytime" },
    { icon: Brain, title: "AI-Powered Insights", description: "Smart recommendations for HR decisions" }
  ];

  const stats = [
    { number: "10,000+", label: "HR Professionals", color: "from-blue-400 to-blue-600" },
    { number: "500,000+", label: "Employees Managed", color: "from-green-400 to-green-600" },
    { number: "99.9%", label: "System Uptime", color: "from-purple-400 to-purple-600" },
    { number: "45%", label: "Time Savings", color: "from-orange-400 to-orange-600" }
  ];
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        />
        <motion.div
          className="absolute bottom-20 left-10 w-24 h-24 bg-gradient-to-r from-green-400/20 to-blue-600/20 rounded-full blur-xl"
          animate={{
            scale: [1.2, 1, 1.2],
            rotate: [360, 180, 0],
          }}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                ...
                From employee management to payroll automation, we've got you covered.
              </motion.p>
              ...
              >
                <div className="bg-white rounded-3xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-500">
                  <div className="space-y-6">
                    ...
                    <motion.div 
                      className="h-32 bg-gradient-to-r from-blue-100 to-purple-100 rounded-xl flex items-center justify-center"
                      animate={{
                        background: [
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From recruitment to retirement, our platform covers every aspect 
              of human resource management with cutting-edge technology.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join thousands of companies who have transformed their HR operations 
          ...
          >
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                className="text-center p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-white hover:from-blue-50 hover:to-purple-50 transition-all duration-300 transform-gpu"
              >
                <motion.div 
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join thousands of HR professionals who have streamlined their processes 
              and improved employee satisfaction with our comprehensive platform.
            </p>
      ...
      <footer className="bg-gray-900 text-gray-300 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp}>
              <div className="flex items-center mb-6">
                ...
                <span className="text-2xl font-bold text-white ml-2">ZAYA HR</span>
              </div>
              <p className="text-gray-400 leading-relaxed">
                Transforming HR operations with innovative technology and 
            ...
            <motion.div variants={fadeInUp}>
              ...
              <ul className="space-y-3">
                {['Employee Management', 'Payroll System', 'Time Tracking', 'Performance Reviews'].map((item) => (
                  <motion.li 
                    key={item}
            ...
            <motion.div variants={fadeInUp}>
              ...
              <ul className="space-y-3">
                {['Documentation', 'Training', 'Support', 'Blog'].map((item) => (
                  <motion.li 
                    key={item}
                    whileHover={{ x: 5, color: '#a855f7' }}
                    className="cursor-pointer transition-colors"
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">© 2025 ZAYA HR Solutions. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
